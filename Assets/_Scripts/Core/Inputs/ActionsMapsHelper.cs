...
namespace Core.Inputs {
    ...
    public class ActionsMapsHelper {
        ...
        public Player PlayerInputs { get; protected set; }
        ...
        public ActionsMapsHelper() {
            // Set ref once
            PlayerInputs = ReInput.players.GetPlayer(0);
        }
        ...
        public void SetActionEnabled(int actionId, bool state) {
            ...
            foreach ( ControllerMap map in PlayerInputs.controllers.maps.GetAllMaps() ) {
        ...
        public void EnableMap(string categoryName, bool reactivateAllActions = true) {
            PlayerInputs.controllers.maps.SetMapsEnabled(true, categoryName);
        ...
        /// </summary>
        /// <param name="categoryName"></param>
        public void DisableMap(string categoryName) { PlayerInputs.controllers.maps.SetMapsEnabled(false, categoryName); }


        public void DisableMap(int categoryId) { PlayerInputs.controllers.maps.SetMapsEnabled(false, categoryId); }
